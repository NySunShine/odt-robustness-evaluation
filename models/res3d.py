...
def create_aa(aa_layer, channels, stride=2, enable=True):
    ...
    return (
        aa_layer(stride)
        if issubclass(aa_layer, nn.AvgPool3d)
...
@register_model
def res3d18(pretrained=False, **kwargs):
...
@register_model
def res3d26(pretrained=False, **kwargs):
...
@register_model
def res3d26t(pretrained=False, **kwargs):
...
@register_model
def res3d26d(pretrained=False, **kwargs):
...
@register_model
def res3d152(pretrained=False, **kwargs):
...
@register_model
def wide_res3d50_2(pretrained=False, **kwargs):
...
@register_model
def wide_res3d101_2(pretrained=False, **kwargs):
...
@register_model
def seres3d18(pretrained=False, **kwargs):
    model_args = dict(
        block=BasicBlock,
        layers=[2, 2, 2, 2],
        block_args=dict(attn_layer="se"),
